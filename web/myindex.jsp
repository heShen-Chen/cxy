...
<a href="" title="聊城职业技术学院"><img src="Picture/logo.png" width="411" height="85" border="0" ></a></div>
...
<div class="slide_container">
    <ul class="rslides" id="slider">
            <li>
        <img src="Picture/bwcx.jpg" alt="">
        </li>
<li>
             <a href="" ><img src="Picture/banner1.jpg" alt="">
                <div class="til_slides">
                    <div class="title">
                        <div class="inner"><h3></h3></div>
                    </div>
                </div>
            </a>
        </li>
<li>
        <img src="Picture/tushuguan.jpg" alt="">
        </li>
    </ul>
</div>
</article>
...
<div id="conter">
  ...
  <div class="con_zw">
   <!--left-->
   <div class="con_zw_left">
   <!--图片滚动--><!--公告通知-->
   <div class="tz_gg">
   <div class="tz_gg_nav">
       <span><a href="FindAllWithPage?itemid=1"><img src="Picture/more.png" width="44" height="9" /></a></span>
       <div style="padding:8px 12px 0px 0px;float:left"><img src="Picture/tz_nav.png" width="28" height="28" /></div>
     通知公告</div>
   <div class="tz_gg_font">
   <ul>
        <div style="height:10px;"></div>
                    <c:forEach var="item" items="${listxwdt}">
                        <div style="height:37px;line-height:37px;border-bottom:1px #bdbdbd dashed; text-indent:21px;background:url(Images/dian.png) 7px center  no-repeat;">
                            <div style="float:right;">${item.tdate}</div>
                            <a href="ContentServlet?id=${item.id}">${item.title}</a>
                        </div>
                    </c:forEach>
           <div class="clear"></div>
   ...
   <!--mid-->
   <div class="con_zw_mid">
   <!--学校要闻-->
   <div class="xx_yw">
   <div class="xx_yw_nav"><span><a href="FindAllWithPage?itemid=2"><img src="Picture/more.png" width="44" height="9" /></a></span><div style="padding:8px 12px 0px 0px;float:left"><img src="Picture/sb.png" width="33" height="23" /></div>
     学校要闻</div>
     <div class="xx_yw_font">
         <c:forEach var="item" items="${listsszx}">
             <div style="height:37px;line-height:37px;border-bottom:1px #bdbdbd dashed; text-indent:21px;background:url(Images/dian.png) 7px center  no-repeat;">
                 <div style="float:right;">${item.tdate}</div>
                 <a href="ContentServlet?id=${item.id}" >${item.title}</a>
             </div>
   ...
   <!--部门动态-->
   <div class="xx_dt">
   <div class="xx_dt_nav"><span><a href="FindAllWithPage?itemid=3"><img src="Picture/more.png" width="44" height="9" /></a></span><div style="padding:10px 12px 0px 0px;float:left"><img src="Picture/bm_nav.png" width="32" height="23" /></div>
     部门动态</div>
   <div class="xx_dt_font">
       <c:forEach var="item" items="${listkszx}">
           <div style="height:37px;line-height:37px;border-bottom:1px #bdbdbd dashed; text-indent:21px;background:url(Images/dian.png) 7px center  no-repeat;">
               <div style="float:right;">${item.tdate}</div>
               <a href="ContentServlet?id=${item.id}">${item.title}</a>
           </div>
   ...
   <!--right-->
   <div class="con_zw_right">
   <!--媒体聊职-->
   <div class="mtzl">
   <div class="ztzl_nav"><span><a href="FindAllWithPage?itemid=4"><img src="Picture/more.png" width="44" height="9" /></a></span><div style="padding:8px 12px 0px 0px;float:left"><img src="Picture/mt.png" width="20" height="25" /></div>
     媒体新闻</div>
    <div class="mtzl_font">
        <c:forEach var="item" items="${listxfgcs1}">
            <div style="height:37px;line-height:37px;border-bottom:1px #bdbdbd dashed; text-indent:21px;background:url(Images/dian.png) 7px center  no-repeat;">
                <div style="float:right;">${item.tdate}</div>
                <a href="ContentServlet?id=${item.id}" >${item.title}</a>
            </div>
   ...
   <!--快速导航-->
   <div class="ks_dh">
       <c:forEach var="item" items="${listxfgcs2}">
           <div style="height:37px;line-height:37px;border-bottom:1px #bdbdbd dashed; text-indent:21px;background:url(Images/dian.png) 7px center  no-repeat;">
               <div style="float:right;">${item.tdate}</div>
               <a href="ContentServlet?id=${item.id}" >${item.title}</a>
           </div>
