...
<%@include file="left.jsp"%>
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加栏目</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="categoryadd.jsp" class="actionBtn add">添加文章</a></h3>
   
        <div id="list">
    <form name="action" method="post" action="CategoryAddServlet">
